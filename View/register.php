<div class="limiter">
    <div class="container-login100" style="background-image: url('Content/login/images/bg-01.jpg');">
        <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
            <form class="login100-form validate-form" action="index.php?action=register&act=register_action" method="post">
                ...
                <div class="wrap-input100 validate-input" data-validate="Password is required">
                    ...
                    <input class="input100" type="text" name="name" placeholder="Repeat your password">
                ...
                <div class="wrap-input100 validate-input m-b-23" data-validate="Username is reauired">
                    <span class="label-input100">YourEmail</span>
